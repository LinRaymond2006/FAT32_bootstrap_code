...
;PROTOTYPE OF THE DISK PACKET
;ALTERNATIVE:USE "PUSH" TO DEPLOY THESE ONTO STACK(REMEMBER TO BALANCE THE STACK AFTER USE!)
;DISK_PACKET:
;	.PACKET_SIZE:	DB 0X10
;	.RESERVED:		DB 0
;	SECTOR_COUNT:	DW 0
